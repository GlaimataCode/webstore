		...
		<div class="grid gap-5">
			...
			<ul class="flex flex-col mt-3">
					...
					<button type="button" wire:click="checkout"
						wire:click=class="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg cursor-pointer gap-x-2 hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
						Checkout Now
					</button>
				</div>
			</div>
