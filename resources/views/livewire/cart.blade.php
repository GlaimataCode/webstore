		...
		<div class="grid gap-10 md:grid-cols-10">
					...
					@forelse ($items as $item)
						<div class="flex items-center gap-5 pb-5 border-b border-gray-200">
							<div class="relative w-40 h-40 overflow-hidden rounded-xl">
								<img class="object-coversize-full" src="{{ $item->product()->cover_url }}" alt="{{ $item->sku }}">
							</div>
			...
			<div class="md:col-span-3">
				...
				<div class="grid gap-5">
					...
					<!-- End List Group -->
					<button type="button" wire:click="checkout" wire:loading.attr="disable" class="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg cursor-pointer gap-x-2 hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
								Checkout Now
